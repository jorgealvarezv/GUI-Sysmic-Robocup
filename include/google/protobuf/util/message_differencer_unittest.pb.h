...
class TestDiffMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestDiffMessage) */ {
 public:
  ...
  PROTOBUF_DEPRECATED ::google::protobuf::RepeatedPtrField< ::protobuf_unittest::TestField >*
      mutable_rm();
  ...
  PROTOBUF_DEPRECATED const ::google::protobuf::RepeatedPtrField< ::protobuf_unittest::TestField >&
      rm() const;
  ...
  PROTOBUF_DEPRECATED ::google::protobuf::int32 v() const;
  PROTOBUF_DEPRECATED void set_v(::google::protobuf::int32 value);
