...
#ifndef PROTOBUF_INCLUDED_google_2fprotobuf_2funittest_5fproto3_2eproto
#define PROTOBUF_INCLUDED_google_2fprotobuf_2funittest_5fproto3_2eproto
...
enum TestAllTypes_NestedEnum {
  ...
  TestAllTypes_NestedEnum_TestAllTypes_NestedEnum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  TestAllTypes_NestedEnum_TestAllTypes_NestedEnum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
enum TestOneof2_NestedEnum {
  ...
  TestOneof2_NestedEnum_TestOneof2_NestedEnum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  TestOneof2_NestedEnum_TestOneof2_NestedEnum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
bool TestOneof2_NestedEnum_IsValid(int value);
const TestOneof2_NestedEnum TestOneof2_NestedEnum_NestedEnum_MIN = TestOneof2_NestedEnum_UNKNOWN;
...
enum ForeignEnum {
  ...
  FOREIGN_BAR = 5,
  FOREIGN_BAZ = 6,
  ForeignEnum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  ForeignEnum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class TestAllTypes_NestedMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_unittest.TestAllTypes.NestedMessage) */ {
 public:
...
class TestAllTypes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_unittest.TestAllTypes) */ {
 public:
  TestAllTypes();
...
class TestPackedTypes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_unittest.TestPackedTypes) */ {
 public:
  TestPackedTypes();
...
class TestUnpackedTypes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_unittest.TestUnpackedTypes) */ {
 public:
  TestUnpackedTypes();
...
class NestedTestAllTypes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_unittest.NestedTestAllTypes) */ {
 public:
  NestedTestAllTypes();
...
class ForeignMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_unittest.ForeignMessage) */ {
 public:
  ForeignMessage();
...
class TestEmptyMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_unittest.TestEmptyMessage) */ {
 public:
  TestEmptyMessage();
...
class TestOneof2 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_unittest.TestOneof2) */ {
 public:
  TestOneof2();
  virtual ~TestOneof2();
  ...
  TestOneof2* New(::google::protobuf::Arena* arena) const final {
  ...
  static const NestedEnum UNKNOWN =
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_google_2fprotobuf_2funittest_5fproto3_2eproto
