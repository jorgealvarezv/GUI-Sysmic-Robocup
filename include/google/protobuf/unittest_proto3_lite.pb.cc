  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 21: {
        ...
        ptr = ::google::protobuf::io::Parse64(ptr, &val);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ::proto3_lite_unittest::TestAllTypes_NestedEnum value = static_cast<::proto3_lite_unittest::TestAllTypes_NestedEnum>(val);
      ...
      case 22: {
        ...
        ptr = ::google::protobuf::io::Parse64(ptr, &val);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ::proto3_lite_unittest::ForeignEnum value = static_cast<::proto3_lite_unittest::ForeignEnum>(val);
