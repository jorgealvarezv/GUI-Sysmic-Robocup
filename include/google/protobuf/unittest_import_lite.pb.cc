...
class ImportMessageLiteDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<ImportMessageLite> _instance;
} _ImportMessageLite_default_instance_;
}  // namespace protobuf_unittest_import
static void InitDefaultsImportMessageLite_google_2fprotobuf_2funittest_5fimport_5flite_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_ImportMessageLite_google_2fprotobuf_2funittest_5fimport_5flite_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsImportMessageLite_google_2fprotobuf_2funittest_5fimport_5flite_2eproto}, {}};
...
class ImportMessageLite::HasBitSetters {
 public:
  static void set_has_d(ImportMessageLite* msg) {
...
const ImportMessageLite& ImportMessageLite::default_instance() {
  ::google::protobuf::internal::InitSCC(&::scc_info_ImportMessageLite_google_2fprotobuf_2funittest_5fimport_5flite_2eproto.base);
...
const char* ImportMessageLite::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<ImportMessageLite*>(object);
