...
class PublicImportMessageLiteDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<PublicImportMessageLite> _instance;
} _PublicImportMessageLite_default_instance_;
}  // namespace protobuf_unittest_import
static void InitDefaultsPublicImportMessageLite_google_2fprotobuf_2funittest_5fimport_5fpublic_5flite_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_PublicImportMessageLite_google_2fprotobuf_2funittest_5fimport_5fpublic_5flite_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsPublicImportMessageLite_google_2fprotobuf_2funittest_5fimport_5fpublic_5flite_2eproto}, {}};
...
class PublicImportMessageLite::HasBitSetters {
 public:
  static void set_has_e(PublicImportMessageLite* msg) {
...
const PublicImportMessageLite& PublicImportMessageLite::default_instance() {
  ::google::protobuf::internal::InitSCC(&::scc_info_PublicImportMessageLite_google_2fprotobuf_2funittest_5fimport_5fpublic_5flite_2eproto.base);
...
const char* PublicImportMessageLite::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<PublicImportMessageLite*>(object);
