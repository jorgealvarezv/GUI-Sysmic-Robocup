  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 13: {
        ...
        std::memcpy(&val, ptr, 4);
        ptr += 4;
        msg->set_derived_camera_world_tx(val);
        break;
      }
      ...
      case 14: {
        ...
        std::memcpy(&val, ptr, 4);
        ptr += 4;
        msg->set_derived_camera_world_ty(val);
        break;
      }
      ...
      case 15: {
        ...
        std::memcpy(&val, ptr, 4);
        ptr += 4;
        msg->set_derived_camera_world_tz(val);
        break;
      }
      default: {
      handle_unusual:
