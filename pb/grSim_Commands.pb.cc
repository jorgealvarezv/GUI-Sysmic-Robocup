...
extern PROTOBUF_INTERNAL_EXPORT_grSim_5fCommands_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_grSim_Robot_Command_grSim_5fCommands_2eproto;
class grSim_Robot_CommandDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<grSim_Robot_Command> _instance;
} _grSim_Robot_Command_default_instance_;
class grSim_CommandsDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<grSim_Commands> _instance;
} _grSim_Commands_default_instance_;
static void InitDefaultsgrSim_Robot_Command_grSim_5fCommands_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_grSim_Robot_Command_grSim_5fCommands_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsgrSim_Robot_Command_grSim_5fCommands_2eproto}, {}};

static void InitDefaultsgrSim_Commands_grSim_5fCommands_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_grSim_Commands_grSim_5fCommands_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsgrSim_Commands_grSim_5fCommands_2eproto}, {
      &scc_info_grSim_Robot_Command_grSim_5fCommands_2eproto.base,}};

void InitDefaults_grSim_5fCommands_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_grSim_Robot_Command_grSim_5fCommands_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_grSim_Commands_grSim_5fCommands_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_grSim_5fCommands_2eproto[2];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_grSim_5fCommands_2eproto = nullptr;
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_grSim_5fCommands_2eproto = nullptr;

const ::google::protobuf::uint32 TableStruct_grSim_5fCommands_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_grSim_5fCommands_2eproto = {
  {}, AddDescriptors_grSim_5fCommands_2eproto, "grSim_Commands.proto", schemas,
  file_default_instances, TableStruct_grSim_5fCommands_2eproto::offsets,
...
const char descriptor_table_protodef_grSim_5fCommands_2eproto[] =
  ...
  "mand"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_grSim_5fCommands_2eproto = {
  false, InitDefaults_grSim_5fCommands_2eproto, 
  descriptor_table_protodef_grSim_5fCommands_2eproto,
  "grSim_Commands.proto", &assign_descriptors_table_grSim_5fCommands_2eproto, 364,
};

void AddDescriptors_grSim_5fCommands_2eproto() {
  static constexpr ::google::protobuf::internal::InitFunc deps[1] =
  {
  };
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_grSim_5fCommands_2eproto, deps, 0);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_grSim_5fCommands_2eproto = []() { AddDescriptors_grSim_5fCommands_2eproto(); return true; }();

// ===================================================================

void grSim_Robot_Command::InitAsDefaultInstance() {
}
class grSim_Robot_Command::HasBitSetters {
 public:
  static void set_has_id(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000001u;
  }
  static void set_has_kickspeedx(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000002u;
  }
  static void set_has_kickspeedz(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000004u;
  }
  static void set_has_veltangent(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000008u;
  }
  static void set_has_velnormal(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000010u;
  }
  static void set_has_velangular(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000020u;
  }
  static void set_has_spinner(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000040u;
  }
  static void set_has_wheelsspeed(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000080u;
  }
  static void set_has_wheel1(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000100u;
  }
  static void set_has_wheel2(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000200u;
  }
  static void set_has_wheel3(grSim_Robot_Command* msg) {
    msg->_has_bits_[0] |= 0x00000400u;
  }
  static void set_has_wheel4(grSim_Robot_Command* msg) {
...
const char* grSim_Robot_Command::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<grSim_Robot_Command*>(object);
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (21 & 0xFF)) {
          HasBitSetters::set_has_kickspeedx(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (29 & 0xFF)) {
          HasBitSetters::set_has_kickspeedz(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &kickspeedz_)));
        } else {
      ...
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (37 & 0xFF)) {
          HasBitSetters::set_has_veltangent(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &veltangent_)));
        } else {
      ...
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (45 & 0xFF)) {
          HasBitSetters::set_has_velnormal(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &velnormal_)));
        } else {
      ...
      case 6: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (53 & 0xFF)) {
          HasBitSetters::set_has_velangular(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &velangular_)));
        } else {
      ...
      case 7: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (56 & 0xFF)) {
          HasBitSetters::set_has_spinner(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
      ...
      case 8: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (64 & 0xFF)) {
          HasBitSetters::set_has_wheelsspeed(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   bool, ::google::protobuf::internal::WireFormatLite::TYPE_BOOL>(
                 input, &wheelsspeed_)));
        } else {
      ...
      case 9: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (77 & 0xFF)) {
          HasBitSetters::set_has_wheel1(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &wheel1_)));
        } else {
      ...
      case 10: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (85 & 0xFF)) {
          HasBitSetters::set_has_wheel2(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &wheel2_)));
        } else {
      ...
      case 11: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (93 & 0xFF)) {
          HasBitSetters::set_has_wheel3(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &wheel3_)));
        } else {
      ...
      case 12: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (101 & 0xFF)) {
          HasBitSetters::set_has_wheel4(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &wheel4_)));
        } else {
...
// @@protoc_insertion_point(generalized_merge_from_start:grSim_Robot_Command)
  ...
  const grSim_Robot_Command* source =
      ::google::protobuf::DynamicCastToGenerated<grSim_Robot_Command>(
          &from);
  if (source == nullptr) {
...
::google::protobuf::Metadata grSim_Robot_Command::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_grSim_5fCommands_2eproto);
  return ::file_level_metadata_grSim_5fCommands_2eproto[kIndexInFileMessages];
}
...
class grSim_Commands::HasBitSetters {
 public:
  static void set_has_timestamp(grSim_Commands* msg) {
    msg->_has_bits_[0] |= 0x00000001u;
  }
  static void set_has_isteamyellow(grSim_Commands* msg) {
    msg->_has_bits_[0] |= 0x00000002u;
  }
};
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* grSim_Commands::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<grSim_Commands*>(object);
  ::google::protobuf::uint32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
    ...
    switch (tag >> 3) {
      ...
      case 3: {
        ...
        do {
          ...
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          parser_till_end = ::grSim_Robot_Command::_InternalParse;
          object = msg->add_robot_commands();
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (16 & 0xFF)) {
          HasBitSetters::set_has_isteamyellow(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   bool, ::google::protobuf::internal::WireFormatLite::TYPE_BOOL>(
                 input, &isteamyellow_)));
        } else {
...
// @@protoc_insertion_point(generalized_merge_from_start:grSim_Commands)
  ...
  const grSim_Commands* source =
      ::google::protobuf::DynamicCastToGenerated<grSim_Commands>(
          &from);
  if (source == nullptr) {
