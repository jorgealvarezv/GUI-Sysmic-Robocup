  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 9: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ::google::protobuf::int32 value = val;
        msg->set_center_circle_radius(value);
        break;
      }
      ...
      case 12: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ::google::protobuf::int32 value = val;
        msg->set_free_kick_from_defense_dist(value);
        break;
      }
      ...
      case 13: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ::google::protobuf::int32 value = val;
        msg->set_penalty_spot_from_field_line_dist(value);
        break;
      }
      ...
      case 14: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ::google::protobuf::int32 value = val;
        msg->set_penalty_line_from_spot_dist(value);
        break;
      }
      default: {
      handle_unusual:
